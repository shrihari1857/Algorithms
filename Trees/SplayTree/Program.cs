...
namespace SplayTree
{
    class Program
    {
       // public static Node root;
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("The size 0 is: " + st.size());
            //st.remove("www.yale.edu");
            //Console.WriteLine("The size 1 is: " + st.size());
            //st.remove("www.princeton.edu");
            //Console.WriteLine("The size 2 is: " + st.size());
            //st.remove("non-member");
            //Console.WriteLine("The size 3 is: " + st.size());
            //Console.WriteLine(st.get("www.cs.princeton.edu"));
            //Console.WriteLine("The size 4 is: " + st.size());
            //Console.WriteLine(st.get("www.yale.com"));
            //Console.WriteLine("The size 5 is: " + st.size());
            //Console.WriteLine(st.get("www.simpsons.com"));
            //Console.WriteLine("The size 6 is: " + st.size());
            Console.WriteLine();
        }
    ...
    ***************************************************************************/
    ...
    {
        public int key;            // key
        public string value;        // associated data
